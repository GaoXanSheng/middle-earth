...
public class StoneTrollEntity extends TrollEntity {
    ...
    protected void readAdditionalSaveData(ValueInput view) {
        ...
        this.entityData.set(PETRIFYING, view.getIntOr("Petrifying", 0));
    }
    ...
    public static boolean canSpawn(EntityType<StoneTrollEntity> type, ServerLevelAccessor serverWorldAccess, EntitySpawnReason spawnReason, BlockPos blockPos, RandomSource random) {

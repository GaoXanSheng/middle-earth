...
public class WargArmorFrontSkullFeatureRenderer extends RenderLayer<WargEntityRenderState, WargModel> {
    ...
    public WargArmorFrontSkullFeatureRenderer(RenderLayerParent<WargEntityRenderState, WargModel> context, EntityModelSet loader, EquipmentLayerRenderer equipmentRenderer) {
        super(context);

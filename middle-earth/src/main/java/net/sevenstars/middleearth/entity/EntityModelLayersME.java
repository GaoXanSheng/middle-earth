...
public final class EntityModelLayersME {
    ...
    public static final ModelLayerLocation GREAT_HORN_BABY = EntityModelLayersME.registerEntityModelLayer("great_horn_baby", GreatHornModel.getTexturedModelData().apply(GreatHornModel.BABY_TRANSFORMER));
    ...
    private static ModelLayerLocation registerEntityModelLayer(String registryName, LayerDefinition modelData) {
        ModelLayerLocation entityModelLayer = new ModelLayerLocation(Identifier.fromNamespaceAndPath(MiddleEarth.MOD_ID, registryName), MAIN);
    ...
    private static ModelLayerLocation registerEntityModelLayer(String id, String layer, LayerDefinition modelData) {
        ModelLayerLocation entityModelLayer = new ModelLayerLocation(Identifier.fromNamespaceAndPath(MiddleEarth.MOD_ID, id), layer);
        ModelLayerRegistry.registerModelLayer(entityModelLayer, () -> modelData);
        return entityModelLayer;
    }
}

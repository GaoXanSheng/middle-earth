...
public class ShelobiteLarvaModel extends EntityModel<ShelobiteScuttlerRenderState> {
    ...
    public ShelobiteLarvaModel(ModelPart root) {
        ...
        this.walkingAnimation = ShelobiteLarvaAnimations.SHELOBITE_LARVA_WALK.bake(root);
        this.biteAnimation = ShelobiteLarvaAnimations.SHELOBITE_LARVA_BITE.bake(root);
    }
    ...
    public void setupAnim(ShelobiteScuttlerRenderState state) {
        ...
        this.walkingAnimation.applyWalk(state.walkAnimationPos, state.walkAnimationSpeed, 3F, 2.5F);
        this.biteAnimation.apply(state.biteAnimationState, state.ageInTicks, 1.25f);
    }
}
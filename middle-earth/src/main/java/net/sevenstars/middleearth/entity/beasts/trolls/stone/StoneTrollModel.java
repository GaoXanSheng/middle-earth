...
public class StoneTrollModel extends EntityModel<TrollEntityRenderState> {
    ...
    public StoneTrollModel(ModelPart root) {
        ...
        this.walkingAnimation = StoneTrollAnimations.WALK.bake(root);
        this.attackinggAnimation = StoneTrollAnimations.ATTACK.bake(root);
        this.chargingAnimation = StoneTrollAnimations.CHARGE.bake(root);
        this.throwingAnimation = StoneTrollAnimations.THROW.bake(root);
    }

...
public class ShelobiteScuttlerEntity extends Monster implements Pouncer {
    ...
    public SpawnGroupData finalizeSpawn(ServerLevelAccessor world, DifficultyInstance difficulty, EntitySpawnReason spawnReason, @Nullable SpawnGroupData entityData) {
        if (entityData instanceof SpiderData spiderData) {
            ...
            Optional<? extends Holder<SpiderVariant>> optional = VariantUtils.selectVariantToSpawn(SpawnContext.create(world, this.blockPosition()), DynamicRegistriesME.SPIDER_VARIANTS);
    ...
    public static boolean canSpawn(EntityType<NpcEntity> type, LevelAccessor worldAccess, EntitySpawnReason spawnReason, BlockPos pos, RandomSource random) {
        ...
        if (spawnReason == EntitySpawnReason.NATURAL && worldAccess instanceof ServerLevel world) {
    ...
    protected Brain.Provider<ShelobiteScuttlerEntity> brainProvider() {
        return Brain.provider(MEMORY_MODULE_TYPES, SENSOR_TYPES, ShelobiteScuttlerBrain::getActivities);
    }

    @Override
    protected Brain<?> makeBrain(Brain.Packed packed) {
        return this.brainProvider().makeBrain(this, packed);
    }
    ...
    protected void defineSynchedData(SynchedEntityData.Builder builder) {
        ...
        Holder<SpiderVariant> spiderVariantRegistryEntry = VariantUtils.getDefaultOrAny(this.registryAccess(), SpiderVariantRegistry.DEFAULT);
    ...
    public void makeStuckInBlock(BlockState state, Vec3 multiplier) {
        if (!state.is(TagKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(MiddleEarth.MOD_ID, "cobwebs")))) {
    ...
    protected void readAdditionalSaveData(ValueInput view) {
        ...
        VariantUtils.readVariant(view, DynamicRegistriesME.SPIDER_VARIANTS).ifPresent(this::setVariant);
    }
    ...
    public static boolean canSpawn(EntityType<ShelobiteScuttlerEntity> type, ServerLevelAccessor serverWorldAccess, EntitySpawnReason spawnReason, BlockPos blockPos, RandomSource random) {

...
public class WargArmorSideSkullsFeatureRenderer extends RenderLayer<WargEntityRenderState, WargModel> {
    private static final Identifier TEXTURE = Identifier.fromNamespaceAndPath(MiddleEarth.MOD_ID, "textures/entities/warg/feature/warg_armor_side_skull_addon.png");
    private final WargArmorSideAddonsModel model;

    public WargArmorSideSkullsFeatureRenderer(RenderLayerParent<WargEntityRenderState, WargModel> context, EntityModelSet loader, EquipmentLayerRenderer equipmentRenderer) {
        super(context);

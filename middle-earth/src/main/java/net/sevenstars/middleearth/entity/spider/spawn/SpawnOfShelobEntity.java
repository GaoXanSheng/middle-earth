...
public class SpawnOfShelobEntity extends Monster implements Pouncer, Shielder, CooldownRangedAttackMob {
    ...
    public void performRangedAttack(LivingEntity target, float pullProgress) {
        ...
        if (this.level() instanceof ServerLevel serverWorld) {
            ...
            Projectile.spawnProjectile(
                    ...
                    entity -> entity.shoot(dX, e + g - entity.getY(), dZ, 1.6F, 8 - this.level().getDifficulty().getId() * 4)
            );
        }
    ...
    public static boolean canSpawn(EntityType<SpawnOfShelobEntity> type, ServerLevelAccessor serverWorldAccess, EntitySpawnReason spawnReason, BlockPos blockPos, RandomSource random) {

...
public class FactionDataComponent implements TooltipProvider {
    ...
    public static final StreamCodec<RegistryFriendlyByteBuf, FactionDataComponent> PACKET_CODEC =
            StreamCodec.composite(Identifier.STREAM_CODEC, FactionDataComponent::getFactionId, FactionDataComponent::new);

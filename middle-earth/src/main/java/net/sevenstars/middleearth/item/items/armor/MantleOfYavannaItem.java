...
public class MantleOfYavannaItem extends BackAttachmentItem {
    ...
    public MantleOfYavannaItem(Properties settings, ExtendedArmorMaterial material) {
        super(settings.humanoidArmor(material.material(), ArmorType.CHESTPLATE).stacksTo(1), material);
    }
    ...
    public void inventoryTick(ItemStack stack, ServerLevel world, Entity entity, @Nullable EquipmentSlot slot) {
        ...
        if(currentColor != targetColor) {
            ...
            stack.set(DataComponents.DYED_COLOR, new DyedItemColor(currentColor));
        }
    }

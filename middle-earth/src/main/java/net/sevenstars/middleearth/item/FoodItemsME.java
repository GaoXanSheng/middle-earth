...
public class FoodItemsME {
    public static final Consumable BIRCH_BOTTLE = Consumables.defaultDrink().consumeSeconds(2.0F)
            .onConsume(new RemoveStatusEffectsConsumeEffect(MobEffects.POISON)).build();;
    public static final Consumable MAPLE_BOTTLE = Consumables.defaultDrink().consumeSeconds(2.0F)
            .sound(SoundEvents.HONEY_DRINK).build();;
    ...
    public static final Item MAPLE_SYRUP = registerItem("maple_syrup",
            Item::new,new Item.Properties()
                    ...
                    .food(Foods.HONEY_BOTTLE, MAPLE_BOTTLE).stacksTo(16));
    public static final Item BIRCH_WATER = registerItem("birch_water",
            Item::new,new Item.Properties()
                    .craftRemainder(Items.GLASS_BOTTLE).usingConvertsTo(Items.GLASS_BOTTLE)
                    .food(Foods.HONEY_BOTTLE, BIRCH_BOTTLE).stacksTo(16));
    ...
    public static final Item FISH_STEW = registerItem("fish_stew",
            Item::new,new Item.Properties().food(
                    new FoodProperties.Builder().nutrition(8).saturationModifier(1.0f).build()).stacksTo(1).usingConvertsTo(Items.BOWL));
    public static final Item MEAT_BOWL = registerItem("meat_bowl",
            Item::new,new Item.Properties().food(
                    new FoodProperties.Builder().nutrition(12).saturationModifier(1.0f).build()).stacksTo(1).usingConvertsTo(Items.BOWL));
    public static final Item MEAT_EGG_MEAL = registerItem("meat_egg_meal",
            Item::new,new Item.Properties().food(
                    new FoodProperties.Builder().nutrition(9).saturationModifier(0.9f).build()).stacksTo(1).usingConvertsTo(Items.BOWL));
    public static final Item MEAT_SKEWER = registerItem("meat_skewer",
            Item::new,new Item.Properties().food(
                    new FoodProperties.Builder().nutrition(5).saturationModifier(0.6f).build()).stacksTo(8).usingConvertsTo(Items.STICK));
    public static final Item COOKED_MEAT_SKEWER = registerItem("cooked_meat_skewer",
            Item::new,new Item.Properties().food(
                    new FoodProperties.Builder().nutrition(10).saturationModifier(0.8f).build()).stacksTo(8).usingConvertsTo(Items.STICK));
    public static final Item POULTRY_MEAL = registerItem("poultry_meal",
            Item::new,new Item.Properties().food(
                    new FoodProperties.Builder().nutrition(8).saturationModifier(0.8f).build()).stacksTo(8).usingConvertsTo(Items.BOWL));
    public static final Item VEGETABLE_SKEWER = registerItem("vegetable_skewer",
            Item::new,new Item.Properties().food(
                    new FoodProperties.Builder().nutrition(3).saturationModifier(0.3f).build()).stacksTo(8).usingConvertsTo(Items.STICK));
    public static final Item COOKED_VEGETABLE_SKEWER = registerItem("cooked_vegetable_skewer",
            Item::new,new Item.Properties().food(
                    new FoodProperties.Builder().nutrition(6).saturationModifier(0.6f).build()).stacksTo(8).usingConvertsTo(Items.STICK));
    public static final Item VEGETABLE_SOUP = registerItem("vegetable_soup",
            Item::new,new Item.Properties().food(
                    new FoodProperties.Builder().nutrition(7).saturationModifier(0.6f).build()).stacksTo(1).usingConvertsTo(Items.BOWL));
    ...
    private static Item registerItem(String name, Function<Item.Properties, Item> factory, Item.Properties settings) {
        ...
        ItemGroupsME.FOOD_CONTENTS.add(item);
        TranslationEntries.itemEntries.add(item);
        RegistryAliasesME.aliases.add(new RegistryAliasesME.Alias(BuiltInRegistries.ITEM, name));
        return Registry.register(BuiltInRegistries.ITEM, Identifier.fromNamespaceAndPath(MiddleEarth.MOD_ID, name), item);
    }

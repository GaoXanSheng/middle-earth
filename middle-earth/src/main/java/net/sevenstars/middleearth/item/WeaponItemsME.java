...
public class WeaponItemsME {
    ...
    public static final Item WOODEN_DAGGER = registerItemWithModel("wooden_dagger",
            (settings) -> new CustomDaggerWeaponItem(ToolMaterial.WOOD, settings), new Item.Properties(), false);
    public static final Item WOODEN_SPEAR = registerItemWithSpearModel("wooden_spear",
            (settings) -> new CustomSpearWeaponItem(ToolMaterial.WOOD, settings), new Item.Properties());

    public static final Item STONE_DAGGER = registerItemWithModel("stone_dagger",
            (settings) -> new CustomDaggerWeaponItem(ToolMaterial.STONE, settings), new Item.Properties(), false);
    public static final Item STONE_SPEAR = registerItemWithSpearModel("stone_spear",
            (settings) -> new CustomSpearWeaponItem(ToolMaterial.STONE, settings), new Item.Properties());
    ...
    public static final Item IRON_DAGGER = registerItemWithModel("iron_dagger",
            (settings) -> new CustomDaggerWeaponItem(ToolMaterial.IRON, settings), new Item.Properties(), false);
    public static final Item IRON_SPEAR = registerItemWithSpearModel("iron_spear",
            (settings) -> new CustomSpearWeaponItem(ToolMaterial.IRON, settings), new Item.Properties());

    public static final Item GOLDEN_DAGGER = registerItemWithModel("golden_dagger",
            (settings) -> new CustomDaggerWeaponItem(ToolMaterial.GOLD, settings), new Item.Properties(), false);
    public static final Item GOLDEN_SPEAR = registerItemWithSpearModel("golden_spear",
            (settings) -> new CustomSpearWeaponItem(ToolMaterial.GOLD, settings), new Item.Properties());
    ...
    public static final Item DIAMOND_DAGGER = registerItemWithModel("diamond_dagger",
            (settings) -> new CustomDaggerWeaponItem(ToolMaterial.DIAMOND, settings), new Item.Properties(), false);
    public static final Item DIAMOND_SPEAR = registerItemWithSpearModel("diamond_spear",
            (settings) -> new CustomSpearWeaponItem(ToolMaterial.DIAMOND, settings), new Item.Properties());

    public static final Item NETHERITE_DAGGER = registerItemWithModel("netherite_dagger",
            (settings) -> new CustomDaggerWeaponItem(ToolMaterial.NETHERITE, settings), new Item.Properties(), false);
    public static final Item NETHERITE_SPEAR = registerItemWithSpearModel("netherite_spear",
            (settings) -> new CustomSpearWeaponItem(ToolMaterial.NETHERITE, settings), new Item.Properties());
    ...
    private static Item registerItemWithModel(String name, Function<Item.Properties, Item> factory, Item.Properties settings, boolean isDualModel) {
        ...
        ItemGroupsME.WEAPONS_CONTENTS.add(item);
        if(isDualModel) {
    ...
    private static Item registerItemNoModel(String name, Function<Item.Properties, Item> factory) {
        Item item = (Item)factory.apply(new Item.Properties().setId(ModBlocks.keyOfItem(name)));
        ItemGroupsME.WEAPONS_CONTENTS.add(item);
        return registerItem(item, name);
    }
    ...
    private static Item registerBowItem(String name, Function<Item.Properties, Item> factory, Item.Properties settings) {
        Item item = (Item)factory.apply(settings.enchantable(2).setId(ModBlocks.keyOfItem(name)));
        ItemGroupsME.WEAPONS_CONTENTS.add(item);
    ...
    private static Item registerCrossbowItem(String name, Function<Item.Properties, Item> factory, Item.Properties settings) {
        Item item = (Item)factory.apply(settings.stacksTo(1).durability(465)
                .component(DataComponents.CHARGED_PROJECTILES, ChargedProjectiles.EMPTY).enchantable(1)
                .setId(ModBlocks.keyOfItem(name)));
        ItemGroupsME.WEAPONS_CONTENTS.add(item);

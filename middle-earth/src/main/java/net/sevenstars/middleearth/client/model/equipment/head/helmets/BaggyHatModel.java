...
public class BaggyHatModel extends HelmetAddonModel {
    ...
    public static LayerDefinition getTexturedModelData() {
        ...
        PartDefinition baggy_hat = head.addOrReplaceChild("baggy_hat", CubeListBuilder.create().texOffs(0, 0)
                .addBox(-5.0F, -10.5F, -3.0F, 7.0F, 3.0F, 6.0F,
                        new CubeDeformation(0.6F)), PartPose.offset(0.0F, 0.0F, 0.0F));

...
public class MonocleModel extends HelmetAddonModel {
    ...
    public static LayerDefinition getTexturedModelData() {
        ...
        PartDefinition addon_monocle = head.addOrReplaceChild("addon_monocle", CubeListBuilder.create().texOffs(36, 31)
                .addBox(-3.25F, -4.5F, -6.75F, 2.0F, 2.0F, 1.0F,
                        new CubeDeformation(0.3F)), PartPose.offset(0.0F, 0.0F, 0.0F));

        PartDefinition monocle = head.addOrReplaceChild("monocle", CubeListBuilder.create().texOffs(32, 23)
                .addBox(1.0F, -1.0F, -4.0F, 5.0F, 2.0F, 5.0F,
                        new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-5.0F, -3.0F, 0.0F, 0.0F, 0.5236F, 0.0F));

...
public class ChaperonModel extends HelmetAddonModel {
    ...
    public static LayerDefinition getTexturedModelData() {
        ...
        PartDefinition chaperon = head.addOrReplaceChild("chaperon", CubeListBuilder.create().texOffs(2, 2)
                .addBox(-1.0F, -3.5F, -3.0F, 2.0F, 9.0F, 6.0F,
                        new CubeDeformation(0.0F)), PartPose.offset(5.0F, -5.0F, 0.0F));

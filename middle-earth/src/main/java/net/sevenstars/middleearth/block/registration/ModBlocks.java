...
public class ModBlocks {
    ...
    public static final Block POINTED_DOLOMITE = registerStoneBlock("pointed_dolomite",
            PointedDolomiteBlock::new,BlockBehaviour.Properties.ofFullCopy(Blocks.POINTED_DRIPSTONE).randomTicks().strength(1.5F, 3.0F).dynamicShape().offsetType(BlockBehaviour.OffsetType.XZ).pushReaction(PushReaction.DESTROY).isRedstoneConductor(Blocks::never), false);
    public static final Block POINTED_LIMESTONE = registerStoneBlock("pointed_limestone",
            PointedLimestoneBlock::new,BlockBehaviour.Properties.ofFullCopy(Blocks.POINTED_DRIPSTONE).randomTicks().strength(1.5F, 3.0F).dynamicShape().offsetType(BlockBehaviour.OffsetType.XZ).pushReaction(PushReaction.DESTROY).isRedstoneConductor(Blocks::never), false);
    public static final Block POINTED_IZHERABAN = registerStoneBlock("pointed_izheraban",
            PointedIzherabanBlock::new,BlockBehaviour.Properties.ofFullCopy(Blocks.POINTED_DRIPSTONE).randomTicks().strength(1.5F, 3.0F).dynamicShape().offsetType(BlockBehaviour.OffsetType.XZ).pushReaction(PushReaction.DESTROY).isRedstoneConductor(Blocks::never), false);
    public static final Block POINTED_GALONN = registerStoneBlock("pointed_galonn",
            PointedGalonnBlock::new,BlockBehaviour.Properties.ofFullCopy(Blocks.POINTED_DRIPSTONE).randomTicks().strength(1.5F, 3.0F).dynamicShape().offsetType(BlockBehaviour.OffsetType.XZ).pushReaction(PushReaction.DESTROY).isRedstoneConductor(Blocks::never), false);
    ...
    public static final Block NET = registerMiscBlock("net",
            IronBarsBlock::new, BlockBehaviour.Properties.ofFullCopy(Blocks.WOOL.white()).sound(SoundType.WOOL), true);

    public static final Block COPPER_BARS = registerMiscBlock("copper_bars",
            (settings) -> new OxidizablePaneBlock(WeatheringCopper.WeatherState.UNAFFECTED, settings), BlockBehaviour.Properties.ofFullCopy(Blocks.CUT_COPPER_SLAB.weathering().unaffected()), true);
    public static final Block EXPOSED_COPPER_BARS = registerMiscBlock("exposed_copper_bars",
            (settings) -> new OxidizablePaneBlock(WeatheringCopper.WeatherState.EXPOSED, settings), BlockBehaviour.Properties.ofFullCopy(Blocks.CUT_COPPER_SLAB.weathering().exposed()), true);
    public static final Block WEATHERED_COPPER_BARS = registerMiscBlock("weathered_copper_bars",
            (settings) -> new OxidizablePaneBlock(WeatheringCopper.WeatherState.WEATHERED, settings), BlockBehaviour.Properties.ofFullCopy(Blocks.CUT_COPPER_SLAB.weathering().weathered()), true);
    public static final Block OXIDIZED_COPPER_BARS = registerMiscBlock("oxidized_copper_bars",
            (settings) -> new OxidizablePaneBlock(WeatheringCopper.WeatherState.OXIDIZED, settings), BlockBehaviour.Properties.ofFullCopy(Blocks.CUT_COPPER_SLAB.weathering().oxidized()), true);
    public static final Block WAXED_COPPER_BARS = registerMiscBlock("waxed_copper_bars",
            IronBarsBlock::new, BlockBehaviour.Properties.ofFullCopy(Blocks.CUT_COPPER_SLAB.waxed().unaffected()), true);
    public static final Block WAXED_EXPOSED_COPPER_BARS = registerMiscBlock("waxed_exposed_copper_bars",
            IronBarsBlock::new, BlockBehaviour.Properties.ofFullCopy(Blocks.CUT_COPPER_SLAB.waxed().exposed()), true);
    public static final Block WAXED_WEATHERED_COPPER_BARS = registerMiscBlock("waxed_weathered_copper_bars",
            IronBarsBlock::new, BlockBehaviour.Properties.ofFullCopy(Blocks.CUT_COPPER_SLAB.waxed().weathered()), true);
    public static final Block WAXED_OXIDIZED_COPPER_BARS = registerMiscBlock("waxed_oxidized_copper_bars",
            IronBarsBlock::new, BlockBehaviour.Properties.ofFullCopy(Blocks.CUT_COPPER_SLAB.waxed().oxidized()), true);
    ...
    public static final Block CUT_COPPER_WALL = registerMiscBlock("cut_copper_wall",
            (settings) -> new OxidizableWallBlock(WeatheringCopper.WeatherState.UNAFFECTED, settings), BlockBehaviour.Properties.ofFullCopy(Blocks.CUT_COPPER_SLAB.weathering().unaffected()), true);
    public static final Block EXPOSED_CUT_COPPER_WALL = registerMiscBlock("exposed_cut_copper_wall",
            (settings) -> new OxidizableWallBlock(WeatheringCopper.WeatherState.EXPOSED, settings), BlockBehaviour.Properties.ofFullCopy(Blocks.CUT_COPPER_SLAB.weathering().exposed()), true);
    public static final Block WEATHERED_CUT_COPPER_WALL = registerMiscBlock("weathered_cut_copper_wall",
            (settings) -> new OxidizableWallBlock(WeatheringCopper.WeatherState.WEATHERED, settings), BlockBehaviour.Properties.ofFullCopy(Blocks.CUT_COPPER_SLAB.weathering().weathered()), true);
    public static final Block OXIDIZED_CUT_COPPER_WALL = registerMiscBlock("oxidized_cut_copper_wall",
            (settings) -> new OxidizableWallBlock(WeatheringCopper.WeatherState.OXIDIZED, settings), BlockBehaviour.Properties.ofFullCopy(Blocks.CUT_COPPER_SLAB.weathering().oxidized()), true);
    public static final Block WAXED_CUT_COPPER_WALL = registerMiscBlock("waxed_cut_copper_wall",
            WallBlock::new,BlockBehaviour.Properties.ofFullCopy(Blocks.CUT_COPPER_SLAB.waxed().unaffected()), true);
    public static final Block WAXED_EXPOSED_CUT_COPPER_WALL = registerMiscBlock("waxed_exposed_cut_copper_wall",
            WallBlock::new,BlockBehaviour.Properties.ofFullCopy(Blocks.CUT_COPPER_SLAB.waxed().exposed()), true);
    public static final Block WAXED_WEATHERED_CUT_COPPER_WALL = registerMiscBlock("waxed_weathered_cut_copper_wall",
            WallBlock::new,BlockBehaviour.Properties.ofFullCopy(Blocks.CUT_COPPER_SLAB.waxed().weathered()), true);
    public static final Block WAXED_OXIDIZED_CUT_COPPER_WALL = registerMiscBlock("waxed_oxidized_cut_copper_wall",
            WallBlock::new,BlockBehaviour.Properties.ofFullCopy(Blocks.CUT_COPPER_SLAB.waxed().oxidized()), true);

    public static final Block BLACK_WOOL_SLAB = registerMiscBlock("black_wool_slab",
            SlabBlock::new,BlockBehaviour.Properties.ofFullCopy(Blocks.WOOL.white()).ignitedByLava(), true);
    ...
    public static final Block CUT_COPPER_VERTICAL_SLAB = registerMiscBlock("cut_copper_vertical_slab",
            (settings) -> new OxidizableVerticalSlabBlock(WeatheringCopper.WeatherState.UNAFFECTED, settings), BlockBehaviour.Properties.ofFullCopy(Blocks.CUT_COPPER_SLAB.weathering().unaffected()), true);
    public static final Block EXPOSED_CUT_COPPER_VERTICAL_SLAB = registerMiscBlock("exposed_cut_copper_vertical_slab",
            (settings) -> new OxidizableVerticalSlabBlock(WeatheringCopper.WeatherState.EXPOSED, settings), BlockBehaviour.Properties.ofFullCopy(Blocks.CUT_COPPER_SLAB.weathering().exposed()), true);
    public static final Block WEATHERED_CUT_COPPER_VERTICAL_SLAB = registerMiscBlock("weathered_cut_copper_vertical_slab",
            (settings) -> new OxidizableVerticalSlabBlock(WeatheringCopper.WeatherState.WEATHERED, settings), BlockBehaviour.Properties.ofFullCopy(Blocks.CUT_COPPER_SLAB.weathering().weathered()), true);
    public static final Block OXIDIZED_CUT_COPPER_VERTICAL_SLAB = registerMiscBlock("oxidized_cut_copper_vertical_slab",
            (settings) -> new OxidizableVerticalSlabBlock(WeatheringCopper.WeatherState.OXIDIZED, settings), BlockBehaviour.Properties.ofFullCopy(Blocks.CUT_COPPER_SLAB.weathering().oxidized()), true);
    public static final Block WAXED_CUT_COPPER_VERTICAL_SLAB = registerMiscBlock("waxed_cut_copper_vertical_slab",
            VerticalSlabBlock::new, BlockBehaviour.Properties.ofFullCopy(Blocks.CUT_COPPER_SLAB.waxed().unaffected()), true);
    public static final Block WAXED_EXPOSED_CUT_COPPER_VERTICAL_SLAB = registerMiscBlock("waxed_exposed_cut_copper_vertical_slab",
            VerticalSlabBlock::new, BlockBehaviour.Properties.ofFullCopy(Blocks.CUT_COPPER_SLAB.waxed().exposed()), true);
    public static final Block WAXED_WEATHERED_CUT_COPPER_VERTICAL_SLAB = registerMiscBlock("waxed_weathered_cut_copper_vertical_slab",
            VerticalSlabBlock::new, BlockBehaviour.Properties.ofFullCopy(Blocks.CUT_COPPER_SLAB.waxed().weathered()), true);
    public static final Block WAXED_OXIDIZED_CUT_COPPER_VERTICAL_SLAB = registerMiscBlock("waxed_oxidized_cut_copper_vertical_slab",
            VerticalSlabBlock::new, BlockBehaviour.Properties.ofFullCopy(Blocks.CUT_COPPER_SLAB.waxed().oxidized()), true);

    public static final Block BLACK_WOOL_VERTICAL_SLAB = registerMiscBlock("black_wool_vertical_slab",
            VerticalSlabBlock::new, BlockBehaviour.Properties.ofFullCopy(Blocks.WOOL.white()).ignitedByLava(), true);
    ...
    public static final Block BLACK_WOOL_STAIRS = registerMiscBlock("black_wool_stairs",
            (settings) -> new StairBlock(Blocks.WOOL.black().defaultBlockState(), settings), BlockBehaviour.Properties.ofFullCopy(Blocks.WOOL.white()).ignitedByLava(), true);
    ...
    public static final Block CANDLES_LAYERED_CAKE = registerTablessBlock("candles_layered_cake",
            (settings) -> new CandleLayeredCakeBlock(Blocks.CANDLE, settings), BlockBehaviour.Properties.ofFullCopy(Blocks.DYED_CANDLE_CAKE.black()), false);
    public static final Block WHITE_CANDLES_LAYERED_CAKE = registerTablessBlock("white_candles_layered_cake",
            (settings) -> new CandleLayeredCakeBlock(Blocks.DYED_CANDLE.white(), settings), BlockBehaviour.Properties.ofFullCopy(Blocks.DYED_CANDLE_CAKE.black()), false);
    public static final Block ORANGE_CANDLES_LAYERED_CAKE = registerTablessBlock("orange_candles_layered_cake",
            (settings) -> new CandleLayeredCakeBlock(Blocks.DYED_CANDLE.orange(), settings), BlockBehaviour.Properties.ofFullCopy(Blocks.DYED_CANDLE_CAKE.black()), false);
    public static final Block MAGENTA_CANDLES_LAYERED_CAKE = registerTablessBlock("magenta_candles_layered_cake",
            (settings) -> new CandleLayeredCakeBlock(Blocks.DYED_CANDLE.magenta(), settings), BlockBehaviour.Properties.ofFullCopy(Blocks.DYED_CANDLE_CAKE.black()), false);
    public static final Block LIGHT_BLUE_CANDLES_LAYERED_CAKE = registerTablessBlock("light_blue_candles_layered_cake",
            (settings) -> new CandleLayeredCakeBlock(Blocks.DYED_CANDLE.lightBlue(), settings), BlockBehaviour.Properties.ofFullCopy(Blocks.DYED_CANDLE_CAKE.black()), false);
    public static final Block YELLOW_CANDLES_LAYERED_CAKE = registerTablessBlock("yellow_candles_layered_cake",
            (settings) -> new CandleLayeredCakeBlock(Blocks.DYED_CANDLE.yellow(), settings), BlockBehaviour.Properties.ofFullCopy(Blocks.DYED_CANDLE_CAKE.black()), false);
    public static final Block LIME_CANDLES_LAYERED_CAKE = registerTablessBlock("lime_candles_layered_cake",
            (settings) -> new CandleLayeredCakeBlock(Blocks.DYED_CANDLE.lime(), settings), BlockBehaviour.Properties.ofFullCopy(Blocks.DYED_CANDLE_CAKE.black()), false);
    public static final Block PINK_CANDLES_LAYERED_CAKE = registerTablessBlock("pink_candles_layered_cake",
            (settings) -> new CandleLayeredCakeBlock(Blocks.DYED_CANDLE.pink(), settings), BlockBehaviour.Properties.ofFullCopy(Blocks.DYED_CANDLE_CAKE.black()), false);
    public static final Block GRAY_CANDLES_LAYERED_CAKE = registerTablessBlock("gray_candles_layered_cake",
            (settings) -> new CandleLayeredCakeBlock(Blocks.DYED_CANDLE.gray(), settings), BlockBehaviour.Properties.ofFullCopy(Blocks.DYED_CANDLE_CAKE.black()), false);
    public static final Block LIGHT_GRAY_CANDLES_LAYERED_CAKE = registerTablessBlock("light_gray_candles_layered_cake",
            (settings) -> new CandleLayeredCakeBlock(Blocks.DYED_CANDLE.lightGray(), settings), BlockBehaviour.Properties.ofFullCopy(Blocks.DYED_CANDLE_CAKE.black()), false);
    public static final Block CYAN_CANDLES_LAYERED_CAKE = registerTablessBlock("cyan_candles_layered_cake",
            (settings) -> new CandleLayeredCakeBlock(Blocks.DYED_CANDLE.cyan(), settings), BlockBehaviour.Properties.ofFullCopy(Blocks.DYED_CANDLE_CAKE.black()), false);
    public static final Block PURPLE_CANDLES_LAYERED_CAKE = registerTablessBlock("purple_candles_layered_cake",
            (settings) -> new CandleLayeredCakeBlock(Blocks.DYED_CANDLE.purple(), settings), BlockBehaviour.Properties.ofFullCopy(Blocks.DYED_CANDLE_CAKE.black()), false);
    public static final Block BLUE_CANDLES_LAYERED_CAKE = registerTablessBlock("blue_candles_layered_cake",
            (settings) -> new CandleLayeredCakeBlock(Blocks.DYED_CANDLE.blue(), settings), BlockBehaviour.Properties.ofFullCopy(Blocks.DYED_CANDLE_CAKE.black()), false);
    public static final Block BROWN_CANDLES_LAYERED_CAKE = registerTablessBlock("brown_candles_layered_cake",
            (settings) -> new CandleLayeredCakeBlock(Blocks.DYED_CANDLE.brown(), settings), BlockBehaviour.Properties.ofFullCopy(Blocks.DYED_CANDLE_CAKE.black()), false);
    public static final Block GREEN_CANDLES_LAYERED_CAKE = registerTablessBlock("green_candles_layered_cake",
            (settings) -> new CandleLayeredCakeBlock(Blocks.DYED_CANDLE.green(), settings), BlockBehaviour.Properties.ofFullCopy(Blocks.DYED_CANDLE_CAKE.black()), false);
    public static final Block RED_CANDLES_LAYERED_CAKE = registerTablessBlock("red_candles_layered_cake",
            (settings) -> new CandleLayeredCakeBlock(Blocks.DYED_CANDLE.red(), settings), BlockBehaviour.Properties.ofFullCopy(Blocks.DYED_CANDLE_CAKE.black()), false);
    public static final Block BLACK_CANDLES_LAYERED_CAKE = registerTablessBlock("black_candles_layered_cake",
            (settings) -> new CandleLayeredCakeBlock(Blocks.DYED_CANDLE.black(), settings), BlockBehaviour.Properties.ofFullCopy(Blocks.DYED_CANDLE_CAKE.black()), false);

    //

    public static Block registerBlock(String name, Function<BlockBehaviour.Properties, Block> factory, BlockBehaviour.Properties settings, boolean drop, List<net.minecraft.world.level.ItemLike> group){
        Block block = (Block)factory.apply(settings.setId(keyOfBlock(name)));
    ...
    public static Block registerTablessBlock(String name, Function<BlockBehaviour.Properties, Block> factory, BlockBehaviour.Properties settings, boolean drop) {
        Block block = factory.apply(settings.setId(ModBlocks.keyOfBlock(name)));
        if(drop){
            BlockDrops.blocks.add(block);
        }
        RegistryAliasesME.aliases.add(new RegistryAliasesME.Alias(BuiltInRegistries.BLOCK, name));
    ...
    static void registerBlockItem(String name, Block block) {
        var item = Registry.register(BuiltInRegistries.ITEM, Identifier.fromNamespaceAndPath(MiddleEarth.MOD_ID, name),
                new BlockItem(block, new Item.Properties().setId(keyOfItem(name))));
    ...
    public static ResourceKey<Block> keyOfBlock(String id) {
        return ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(MiddleEarth.MOD_ID, id));
    }

    public static ResourceKey<Item> keyOfItem(String id) {
        return ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(MiddleEarth.MOD_ID, id));
    }

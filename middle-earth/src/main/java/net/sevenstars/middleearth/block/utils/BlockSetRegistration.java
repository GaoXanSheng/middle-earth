...
public class BlockSetRegistration {
    ...
    public static BlockRecordTypes.RegularSet createRegularSet(String name, float hardness, float blastResistance, MapColor mapColor, NoteBlockInstrument instrument, SoundType soundGroup, boolean pillar, List<ItemLike> group, boolean requiresTool) {
        Block base;
    ...
    public static BlockRecordTypes.SimpleBlocks createSimpleSet(String name, float hardness, float blastResistance, MapColor mapColor, NoteBlockInstrument instrument, SoundType soundGroup, boolean pillar, List<ItemLike> group, boolean requiresTool) {
        Block base;
    ...
    public static BlockRecordTypes.RegularSet createOxidizableSet(String name, float hardness, float blastResistance, MapColor mapColor, NoteBlockInstrument instrument, SoundType soundGroup, boolean pillar, List<ItemLike> group, boolean requiresTool, WeatheringCopper.WeatherState level) {
        Block base;
    ...
    public static BlockRecordTypes.WoodSet createWoodSet(String name, float hardness, float blastResistance, MapColor mapColor, NoteBlockInstrument instrument, SoundType soundGroup, List<ItemLike> group) {
    ...
    public static BlockRecordTypes.WoodSet createStemSet(String name, float hardness, float blastResistance, MapColor mapColor, NoteBlockInstrument instrument, SoundType soundGroup, List<ItemLike> group) {
    ...
    public static BlockRecordTypes.MushroomStemSet createMushroomStemSet(String name, float hardness, float blastResistance, MapColor mapColor, NoteBlockInstrument instrument, SoundType soundGroup, List<ItemLike> group) {
    ...
    public static BlockRecordTypes.PlanksSet createPlanksSet(String name, float hardness, float blastResistance, MapColor mapColor, NoteBlockInstrument instrument, SoundType soundGroup, List<ItemLike> group) {
    ...
    public static BlockRecordTypes.WoodRedstoneBlocks createWoodRedstoneSet(String name, float hardness, float blastResistance, MapColor mapColor, SoundType soundGroup, Block base, List<ItemLike> group) {
        ...
        Block pressurePlate = getVanillaOrCreateNew(name + "_pressure_plate", (settings) -> new PressurePlateBlock(
                BlockSetType.OAK, settings), BlockBehaviour.Properties.ofFullCopy(base).strength(0.5f, blastResistance).mapColor(mapColor).sound(soundGroup).noCollision(), group);

        Block button = getVanillaOrCreateNew(name + "_button", (settings) -> new ButtonBlock(
                BlockSetType.OAK, 30, settings), BlockBehaviour.Properties.ofFullCopy(base).strength(0.5f, blastResistance).mapColor(mapColor).sound(soundGroup).noCollision().pushReaction(PushReaction.DESTROY), group);
    ...
    public static BlockRecordTypes.WoodFurnitureBlocks createWoodFurnitureSet(String name, float hardness, float blastResistance, MapColor mapColor, SoundType soundGroup, Block base, List<ItemLike> group) {
    ...
    public static BlockRecordTypes.BaseStoneSet createMainStoneSet(String name, float hardness, float blastResistance, MapColor mapColor, NoteBlockInstrument instrument, SoundType soundGroup, List<ItemLike> group) {
        ...
        Block pressurePlate = getVanillaOrCreateNew(name + "_pressure_plate", (settings) -> new PressurePlateBlock(
                BlockSetType.STONE, settings), BlockBehaviour.Properties.ofFullCopy(base).noCollision(), group);

        Block button = getVanillaOrCreateNew(name + "_button", (settings) -> new ButtonBlock(
                BlockSetType.STONE, 20, settings), BlockBehaviour.Properties.ofFullCopy(base).noCollision(), group);
        ...
        ItemGroupsME.DECORATIVES_BLOCKS_CONTENT.add(stool);
        ItemGroupsME.DECORATIVES_BLOCKS_CONTENT.add(table);
        ItemGroupsME.DECORATIVES_BLOCKS_CONTENT.add(chair);
    ...
    public static BlockRecordTypes.PillarSet createStonePillarSet(String name, float hardness, float blastResistance, MapColor mapColor, NoteBlockInstrument instrument, SoundType soundGroup, List<ItemLike> group) {
    ...
    public static BlockRecordTypes.PillarSet createStoneChiseledSet(String name, float hardness, float blastResistance, MapColor mapColor, NoteBlockInstrument instrument, SoundType soundGroup, List<ItemLike> group) {
    ...
    public static BlockRecordTypes.CarvedWindow createCarvedWindowSet(String name, float hardness, float blastResistance, MapColor mapColor, NoteBlockInstrument instrument, SoundType soundGroup, List<ItemLike> group) {
        Block block = getVanillaOrCreateNew(name, TransparentBlock::new,
                BlockBehaviour.Properties.of()
                        .mapColor(mapColor).instrument(instrument).sound(soundGroup).strength(hardness, blastResistance).requiresCorrectToolForDrops()
                        .noOcclusion().isValidSpawn(Blocks::never).isRedstoneConductor(Blocks::never).isSuffocating(Blocks::never).isViewBlocking(Blocks::never), group);
    ...
    public static Block getVanillaOrCreateNew(String path, Function<BlockBehaviour.Properties, Block> factory, BlockBehaviour.Properties settings, List<ItemLike> group){
        if (BuiltInRegistries.BLOCK.getValue(Identifier.withDefaultNamespace(path)) == Blocks.AIR){

...
public class SpawnUtil {
    public static boolean canCreatureSpawn(EntityType<?> type, ServerLevelAccessor serverWorldAccess, EntitySpawnReason spawnReason, BlockPos blockPos, RandomSource random) {
        if (spawnReason == EntitySpawnReason.NATURAL && serverWorldAccess instanceof ServerLevel world) {
    ...
    public static boolean canSpawn(BlockPos blockPos, ServerLevelAccessor serverWorldAccess, EntitySpawnReason spawnReason) {

...
public class ModTreePlacedFeatures {
    ...
    public static void bootstrap(BootstrapContext<PlacedFeature> context) {
        ...
        register(context, BIRCH_AND_OAK_PLACED_TREE_KEY, configuredFeatureRegistryEntryLookup.getOrThrow(VegetationFeatures.TREES_BIRCH_AND_OAK_LEAF_LITTER),
        ...
        register(context, PALE_OAK_PLACED_TREE_KEY, configuredFeatureRegistryEntryLookup.getOrThrow(TreeFeatures.PALE_OAK),
                VegetationPlacements.treePlacement(megaRareTree,
                        Blocks.PALE_OAK_SAPLING));
    }

    public static ResourceKey<PlacedFeature> registerKey(String name) {
        return ResourceKey.create(Registries.PLACED_FEATURE, Identifier.fromNamespaceAndPath(MiddleEarth.MOD_ID, name));
    }

...
public class ArcTrunkPlacer extends TrunkPlacer {
    ...
    protected List<FoliagePlacer.FoliageAttachment> createArcBranch(WorldGenLevel world, BiConsumer<BlockPos, BlockState> replacer, RandomSource random, BlockPos.MutableBlockPos mutable,

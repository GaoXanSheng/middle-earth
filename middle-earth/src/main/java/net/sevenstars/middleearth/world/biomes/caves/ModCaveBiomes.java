...
public class ModCaveBiomes {
    ...
    public static Biome createBiome(BiomeColorsDTO biomeColors, MobSpawnSettings.Builder spawnSettings, BiomeGenerationSettings.Builder generationSettings, float temperature, boolean precipitation) {
        ...
        undergroundOres = undergroundOres.stream().sorted(Comparator.comparing(a -> a.identifier().toString())).toList();
        ...
        Biome biome = (new Biome.BiomeBuilder())
                ...
                .downfall(0.5F)
                .setAttribute(EnvironmentAttributes.SKY_COLOR, biomeColors.skyColor)
                .setAttribute(EnvironmentAttributes.FOG_COLOR, biomeColors.fogColor)
                .setAttribute(EnvironmentAttributes.WATER_FOG_COLOR, biomeColors.waterFogColor)

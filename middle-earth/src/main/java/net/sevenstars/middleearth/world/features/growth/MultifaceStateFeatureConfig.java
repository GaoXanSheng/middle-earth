...
public class MultifaceStateFeatureConfig implements FeatureConfiguration {
	public final MultifaceSpreadeableBlock block;
    ...
    public MultifaceStateFeatureConfig(Block block, int searchRange, boolean placeOnFloor, boolean placeOnCeiling,
        ...
        this.block = (MultifaceSpreadeableBlock) block;
    ...
    private static DataResult<MultifaceSpreadeableBlock> validateBlock(Block block) {
		return block instanceof MultifaceSpreadeableBlock multifaceGrowthBlock

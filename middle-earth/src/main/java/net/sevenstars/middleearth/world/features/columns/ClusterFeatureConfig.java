...
public class ClusterFeatureConfig implements FeatureConfiguration {
    ...
    public static final Codec<ClusterFeatureConfig> CODEC = RecordCodecBuilder.create((instance) -> {
        ...
        }), IntProviders.codec(1, 128).fieldOf("height").forGetter((config) -> {
            return config.height;
        }), IntProviders.codec(1, 128).fieldOf("radius").forGetter((config) -> {
        ...
        }), IntProviders.codec(0, 128).fieldOf("dripstone_block_layer_thickness").forGetter((config) -> {
            return config.dripstoneBlockLayerThickness;
        }), FloatProviders.codec(0.0F, 2.0F).fieldOf("density").forGetter((config) -> {
            return config.density;
        }), FloatProviders.codec(0.0F, 2.0F).fieldOf("wetness").forGetter((config) -> {

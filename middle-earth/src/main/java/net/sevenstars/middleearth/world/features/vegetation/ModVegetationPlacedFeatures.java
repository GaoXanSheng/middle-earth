...
public class ModVegetationPlacedFeatures {
    ...
    public static final ResourceKey<PlacedFeature> PATCH_FIREFLY_BUSH_SWAMP = vanillaRegisterKey("patch_firefly_bush_swamp");
    public static final ResourceKey<PlacedFeature> PATCH_FIREFLY_BUSH_SWAMP_NEAR_WATER = vanillaRegisterKey("patch_firefly_bush_near_water_swamp");
    ...
    public static void bootstrap(BootstrapContext<PlacedFeature> featureRegisterable) {
        ...
        Holder.Reference<ConfiguredFeature<?, ?>> wildFlowers = registryEntryLookup.getOrThrow(VegetationFeatures.WILDFLOWER);
        ...
        Holder.Reference<ConfiguredFeature<?, ?>> grass = registryEntryLookup.getOrThrow(VegetationFeatures.GRASS);
        ...
        Holder.Reference<ConfiguredFeature<?, ?>> lilyPad = registryEntryLookup.getOrThrow(VegetationFeatures.WATERLILY);
        ...
        Holder.Reference<ConfiguredFeature<?, ?>> tallGrass = registryEntryLookup.getOrThrow(VegetationFeatures.TALL_GRASS);
    ...
    public static ResourceKey<PlacedFeature> vanillaRegisterKey(String name) {
        return ResourceKey.create(Registries.PLACED_FEATURE, Identifier.parse(name));
    }

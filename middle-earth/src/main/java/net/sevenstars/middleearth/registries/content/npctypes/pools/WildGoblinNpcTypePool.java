...
public class WildGoblinNpcTypePool {
    ...
    static {
        GATHERER = new NpcType(NpcRegistry.WILD_GOBLIN_GATHERER.identifier(), RaceRegistry.GOBLIN, FACTION, TexturePresetsRegistry.WILD_GOBLIN_WEAK, List.of(
        ...
        SCOUT = new NpcType(NpcRegistry.WILD_GOBLIN_SCOUT.identifier(), RaceRegistry.GOBLIN, FACTION, TexturePresetsRegistry.WILD_GOBLIN_WEAK, List.of(
            WeightedGearData.create()
                .add(EquipmentSlot.HEAD, GearSlotPool.create()
                    .add(WeightedItemData.create(Items.AIR).withWeight(3))
        ...
        RIDER = new NpcType(NpcRegistry.WILD_GOBLIN_RIDER.identifier(), RaceRegistry.ORC, FACTION, TexturePresetsRegistry.WILD_GOBLIN_WARRIOR, List.of(
                WeightedGearData.create()
                        .add(EquipmentSlot.HEAD, GearSlotPool.create()
        ...
        WARRIOR = new NpcType(NpcRegistry.WILD_GOBLIN_WARRIOR.identifier(), RaceRegistry.ORC, FACTION, TexturePresetsRegistry.WILD_GOBLIN_WARRIOR, List.of(
                WeightedGearData.create()
                        .add(EquipmentSlot.HEAD, GearSlotPool.create()
                                .add(WeightedItemData.create(Items.AIR).withWeight(3))
                                .add(WeightedItemData.create(EquipmentItemsME.ORCISH_HELMET).withWeight(6))
        ...
        BRUTE = new NpcType(NpcRegistry.WILD_GOBLIN_BRUTE.identifier(), RaceRegistry.URUK, FACTION, TexturePresetsRegistry.WILD_GOBLIN_BRUTE, List.of(
            WeightedGearData.create()
                .add(EquipmentSlot.HEAD, GearSlotPool.create()
                    .add(WeightedItemData.create(Items.AIR).withWeight(3))

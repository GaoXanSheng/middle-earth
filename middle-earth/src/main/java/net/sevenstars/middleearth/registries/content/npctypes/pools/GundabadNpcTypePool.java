...
public class GundabadNpcTypePool {
    ...
    static {
        ...
        GOBLIN = new NpcType(NpcRegistry.GUNDABAD_GOBLIN.identifier(), RaceRegistry.GOBLIN, FACTION, TexturePresetsRegistry.GUNDABAD_GOBLIN, List.of(
        ...
        MILITIA = new NpcType(NpcRegistry.GUNDABAD_MILITIA.identifier(), RaceRegistry.GOBLIN, FACTION, TexturePresetsRegistry.GUNDABAD_GOBLIN, List.of(
                WeightedGearData.create()
                        .add(EquipmentSlot.HEAD, GearSlotPool.create()
                                .add(WeightedItemData.create(Items.AIR).withWeight(3))
        ...
        RIDER = new NpcType(NpcRegistry.GUNDABAD_RIDER.identifier(), RaceRegistry.GOBLIN, FACTION, TexturePresetsRegistry.GUNDABAD_GOBLIN, List.of(
                WeightedGearData.create()
                        .add(EquipmentSlot.HEAD, GearSlotPool.create()
                                .add(WeightedItemData.create(Items.AIR).withWeight(3))
                                .add(WeightedItemData.create(EquipmentItemsME.HOOD).withColors(allColors))
        ...
        SCOUT = new NpcType(NpcRegistry.GUNDABAD_SCOUT.identifier(), RaceRegistry.GOBLIN, FACTION, TexturePresetsRegistry.GUNDABAD_GOBLIN, List.of(
                WeightedGearData.create()
                        .add(EquipmentSlot.HEAD, GearSlotPool.create()
        ...
        WARRIOR = new NpcType(NpcRegistry.GUNDABAD_WARRIOR.identifier(), RaceRegistry.ORC, FACTION, TexturePresetsRegistry.GUNDABAD_HOBGOBLIN, List.of(
                WeightedGearData.create()
                        .add(EquipmentSlot.HEAD, GearSlotPool.create()
        ...
        VETERAN = new NpcType(NpcRegistry.GUNDABAD_VETERAN.identifier(), RaceRegistry.URUK, FACTION, TexturePresetsRegistry.GUNDABAD_HOBGOBLIN, List.of(
                WeightedGearData.create()
                        .add(EquipmentSlot.HEAD, GearSlotPool.create()
        ...
        LEADER = new NpcType(NpcRegistry.GUNDABAD_LEADER.identifier(), RaceRegistry.URUK, FACTION, TexturePresetsRegistry.GUNDABAD_HOBGOBLIN, List.of(
                WeightedGearData.create()
                        .add(EquipmentSlot.HEAD, GearSlotPool.create()

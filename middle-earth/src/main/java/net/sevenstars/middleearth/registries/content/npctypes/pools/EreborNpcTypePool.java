...
public class EreborNpcTypePool {
    ...
    static {
        PEASANT = new NpcType(NpcRegistry.EREBOR_PEASANT.identifier(), RaceRegistry.DWARF, FACTION, TexturePresetsRegistry.LONGBEARDS_EREBOR_DWARF, List.of(
        ...
        MINER = new NpcType(NpcRegistry.EREBOR_MINER.identifier(), RaceRegistry.DWARF, FACTION, TexturePresetsRegistry.LONGBEARDS_EREBOR_DWARF, List.of(
            WeightedGearData.create()
                .add(EquipmentSlot.HEAD, GearSlotPool.create()
        ...
        MILITIA = new NpcType(NpcRegistry.EREBOR_MILITIA.identifier(), RaceRegistry.DWARF, FACTION, TexturePresetsRegistry.LONGBEARDS_EREBOR_DWARF, List.of(
                WeightedGearData.create()
                        .add(EquipmentSlot.HEAD, GearSlotPool.create()
        ...
        SOLDIER = new NpcType(NpcRegistry.EREBOR_SOLDIER.identifier(), RaceRegistry.DWARF, FACTION, TexturePresetsRegistry.LONGBEARDS_EREBOR_DWARF_SOLDIER, List.of(
                WeightedGearData.create()
                        .add(EquipmentSlot.HEAD, GearSlotPool.create()
        ...
        ARCHER = new NpcType(NpcRegistry.EREBOR_ARCHER.identifier(), RaceRegistry.DWARF, FACTION, TexturePresetsRegistry.LONGBEARDS_EREBOR_DWARF_SOLDIER, List.of(
                WeightedGearData.create()
                        .add(EquipmentSlot.HEAD, GearSlotPool.create()
                                .add(WeightedItemData.create(EquipmentItemsME.EREBOR_HELMET).withWeight(3))
                                .add(WeightedItemData.create(EquipmentItemsME.EREBOR_MAIL_COIF).withWeight(2))
        ...
        ELITE = new NpcType(NpcRegistry.EREBOR_ELITE.identifier(), RaceRegistry.DWARF, FACTION, TexturePresetsRegistry.LONGBEARDS_EREBOR_DWARF_SOLDIER, List.of(
                WeightedGearData.create()
                        .add(EquipmentSlot.HEAD, GearSlotPool.create()
        ...
        VETERAN = new NpcType(NpcRegistry.EREBOR_VETERAN.identifier(), RaceRegistry.DWARF, FACTION, TexturePresetsRegistry.LONGBEARDS_EREBOR_DWARF_SOLDIER, List.of(
                WeightedGearData.create()
                        .add(EquipmentSlot.HEAD, GearSlotPool.create()
        ...
        GATEWARDEN = new NpcType(NpcRegistry.EREBOR_GATEWARDEN.identifier(), RaceRegistry.DWARF, FACTION, TexturePresetsRegistry.LONGBEARDS_EREBOR_DWARF_SOLDIER, List.of(
                WeightedGearData.create()
                        .add(EquipmentSlot.HEAD, GearSlotPool.create()
        ...
        LEADER = new NpcType(NpcRegistry.EREBOR_LEADER.identifier(), RaceRegistry.DWARF, FACTION, TexturePresetsRegistry.LONGBEARDS_EREBOR_MIGHTY_DWARF, List.of(
                WeightedGearData.create()
                        .add(EquipmentSlot.HEAD, GearSlotPool.create()
                                .add(WeightedItemData.create(EquipmentItemsME.EREBOR_CAPTAIN_HELMET))
                                .add(WeightedItemData.create())

...
public class GoblinTownNpcTypePool {
    ...
    static {
        ...
        GOBLIN = new NpcType(NpcRegistry.GOBLIN_TOWN_GOBLIN.identifier(), RaceRegistry.GOBLIN, FACTION, TexturePresetsRegistry.GOBLIN_TOWN_GOBLIN, List.of(
        ...
        SCOUT = new NpcType(NpcRegistry.GOBLIN_TOWN_SCOUT.identifier(), RaceRegistry.GOBLIN, FACTION, TexturePresetsRegistry.GOBLIN_TOWN_GOBLIN, List.of(
                WeightedGearData.create()
                        .add(EquipmentSlot.HEAD, GearSlotPool.create()
        ...
        WARRIOR = new NpcType(NpcRegistry.GOBLIN_TOWN_WARRIOR.identifier(), RaceRegistry.GOBLIN, FACTION, TexturePresetsRegistry.GOBLIN_TOWN_WARRIOR, List.of(
                WeightedGearData.create()
                        .add(EquipmentSlot.HEAD, GearSlotPool.create()
                                .add(WeightedItemData.create(Items.AIR).withWeight(2))
        ...
        RIDER = new NpcType(NpcRegistry.GOBLIN_TOWN_RIDER.identifier(), RaceRegistry.GOBLIN, FACTION, TexturePresetsRegistry.GOBLIN_TOWN_WARRIOR, List.of(
                WeightedGearData.create()
                        .add(EquipmentSlot.HEAD, GearSlotPool.create()
                                .add(WeightedItemData.create(EquipmentItemsME.GOBLIN_TOWN_SKULL_CAP))
                                .add(WeightedItemData.create(EquipmentItemsME.GOBLIN_TOWN_BONE_MANDIBLE_CAP))
        ...
        VETERAN = new NpcType(NpcRegistry.GOBLIN_TOWN_VETERAN.identifier(), RaceRegistry.GOBLIN, FACTION, TexturePresetsRegistry.GOBLIN_TOWN_BRUTE, List.of(
                WeightedGearData.create()
                        .add(EquipmentSlot.HEAD, GearSlotPool.create()

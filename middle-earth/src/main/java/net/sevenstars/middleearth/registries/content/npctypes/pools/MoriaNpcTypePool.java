...
public class MoriaNpcTypePool {
    ...
    static {
        ...
        GOBLIN = new NpcType(NpcRegistry.MORIA_GOBLIN.identifier(), RaceRegistry.GOBLIN, FACTION, TexturePresetsRegistry.MORIA_GOBLIN, List.of(
        ...
        MILITIA = new NpcType(NpcRegistry.MORIA_MILITIA.identifier(), RaceRegistry.GOBLIN, FACTION, TexturePresetsRegistry.MORIA_GOBLIN, List.of(
                WeightedGearData.create()
                        .add(EquipmentSlot.HEAD, GearSlotPool.create()
        ...
        SCOUT = new NpcType(NpcRegistry.MORIA_SCOUT.identifier(), RaceRegistry.GOBLIN, FACTION, TexturePresetsRegistry.MORIA_GOBLIN, List.of(
                WeightedGearData.create()
                        .add(EquipmentSlot.HEAD, GearSlotPool.create()
                                .add(WeightedItemData.create(Items.AIR).withWeight(8))
        ...
        WARRIOR = new NpcType(NpcRegistry.MORIA_WARRIOR.identifier(), RaceRegistry.GOBLIN, FACTION, TexturePresetsRegistry.MORIA_GOBLIN, List.of(
                WeightedGearData.create()
                        .add(EquipmentSlot.HEAD, GearSlotPool.create()
        ...
        RIDER = new NpcType(NpcRegistry.MORIA_RIDER.identifier(), RaceRegistry.ORC, FACTION, TexturePresetsRegistry.MORIA_GOBLIN, List.of(
                WeightedGearData.create()
                        .add(EquipmentSlot.HEAD, GearSlotPool.create()
                                .add(WeightedItemData.create(Items.AIR))
                                .add(WeightedItemData.create(EquipmentItemsME.MORIA_GOBLIN_SCREECHER_HELMET))
        ...
        VETERAN = new NpcType(NpcRegistry.MORIA_VETERAN.identifier(), RaceRegistry.ORC, FACTION, TexturePresetsRegistry.MORIA_GOBLIN, List.of(
                WeightedGearData.create()
                        .add(EquipmentSlot.HEAD, GearSlotPool.create()
                                .add(WeightedItemData.create(EquipmentItemsME.MORIA_GOBLIN_BITER_HELMET))
                                .add(WeightedItemData.create(EquipmentItemsME.MORIA_GOBLIN_MANDIBLE_HELMET))
        ...
        CHIEF = new NpcType(NpcRegistry.MORIA_CHIEF.identifier(), RaceRegistry.URUK, FACTION, TexturePresetsRegistry.MORIA_GOBLIN, List.of(
                WeightedGearData.create()
                        .add(EquipmentSlot.HEAD, GearSlotPool.create()

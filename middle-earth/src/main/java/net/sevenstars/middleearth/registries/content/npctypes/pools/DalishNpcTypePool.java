...
public class DalishNpcTypePool {
    ...
    static {
        PEASANT = new NpcType(NpcRegistry.DALE_PEASANT.identifier(), RaceRegistry.HUMAN, FACTION, TexturePresetsRegistry.DALE_PEASANT, List.of(
        ...
        MILITIA = new NpcType(NpcRegistry.DALE_MILITIA.identifier(), RaceRegistry.HUMAN, FACTION, TexturePresetsRegistry.DALE_PEASANT, List.of(
                WeightedGearData.create()
                        .add(EquipmentSlot.HEAD, GearSlotPool.create()
        ...
        SOLDIER = new NpcType(NpcRegistry.DALE_SOLDIER.identifier(), RaceRegistry.HUMAN, FACTION, TexturePresetsRegistry.DALE_PEASANT, List.of(
                WeightedGearData.create()
                        .add(EquipmentSlot.HEAD, GearSlotPool.create()
        ...
        ARCHER = new NpcType(NpcRegistry.DALE_ARCHER.identifier(), RaceRegistry.HUMAN, FACTION, TexturePresetsRegistry.DALE_PEASANT, List.of(
                WeightedGearData.create()
                        .add(EquipmentSlot.HEAD, GearSlotPool.create()
                                .add(WeightedItemData.create(EquipmentItemsME.DALISH_HELMET))
                                .add(WeightedItemData.create(EquipmentItemsME.DALISH_HELMET_BROWN_FUR))
        ...
        KNIGHT = new NpcType(NpcRegistry.DALE_KNIGHT.identifier(), RaceRegistry.HUMAN, FACTION, TexturePresetsRegistry.DALE_PEASANT, List.of(
                WeightedGearData.create()
                        .add(EquipmentSlot.HEAD, GearSlotPool.create()
                                .add(WeightedItemData.create(EquipmentItemsME.KETTLE_HAT_WITH_CLOSED_COIF))
        ...
        ELITE_ARCHER = new NpcType(NpcRegistry.DALE_ELITE_ARCHER.identifier(), RaceRegistry.HUMAN, FACTION, TexturePresetsRegistry.DALE_PEASANT, List.of(
                WeightedGearData.create()
                        .add(EquipmentSlot.HEAD, GearSlotPool.create()
                                .add(WeightedItemData.create(EquipmentItemsME.DALISH_HELMET_BROWN_FUR))
                                .add(WeightedItemData.create(EquipmentItemsME.DALISH_HELMET_BLACK_FUR))
        ...
        VETERAN = new NpcType(NpcRegistry.DALE_VETERAN.identifier(), RaceRegistry.HUMAN, FACTION, TexturePresetsRegistry.DALE_LORD, List.of(
                WeightedGearData.create()
                        .add(EquipmentSlot.HEAD, GearSlotPool.create()
        ...
        SERGEANT = new NpcType(NpcRegistry.DALE_SERGEANT.identifier(), RaceRegistry.HUMAN, FACTION, TexturePresetsRegistry.DALE_LORD, List.of(
                WeightedGearData.create()
                        .add(EquipmentSlot.HEAD, GearSlotPool.create()
                                .add(WeightedItemData.create(EquipmentItemsME.BARDING_SOLDIER_HELMET))

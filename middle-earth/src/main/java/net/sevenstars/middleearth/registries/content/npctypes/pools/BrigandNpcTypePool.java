...
public class BrigandNpcTypePool {
    ...
    static {
        THUG = new NpcType(NpcRegistry.BRIGAND_THUG.identifier(), RaceRegistry.HUMAN, FACTION, TexturePresetsRegistry.BRIGAND_THUG, List.of(
        ...
        THIEF = new NpcType(NpcRegistry.BRIGAND_THIEF.identifier(), RaceRegistry.HUMAN, FACTION, TexturePresetsRegistry.BRIGAND_THUG, List.of(
                WeightedGearData.create()
                        .add(EquipmentSlot.HEAD, GearSlotPool.create()
                                .add(WeightedItemData.create().withWeight(4))
        ...
        MERCENARY = new NpcType(NpcRegistry.BRIGAND_MERCENARY.identifier(), RaceRegistry.HUMAN, FACTION, TexturePresetsRegistry.BRIGAND_MERCENARY, List.of(
                WeightedGearData.create()
                        .add(EquipmentSlot.HEAD, GearSlotPool.create()
        ...
        CHIEFTAIN = new NpcType(NpcRegistry.BRIGAND_CHIEFTAIN.identifier(), RaceRegistry.HUMAN, FACTION, TexturePresetsRegistry.BRIGAND_CHIEF, List.of(
                WeightedGearData.create()
                        .add(EquipmentSlot.HEAD, GearSlotPool.create()

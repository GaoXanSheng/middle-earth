...
public class LorienNpcTypePool {
    ...
    static {
        CIVILIAN = new NpcType(NpcRegistry.LOTHLORIEN_CIVILIAN.identifier(), RaceRegistry.ELF, FACTION, TexturePresetsRegistry.LOTHLORIEN_ELF, List.of(
        ...
        SENTINEL = new NpcType(NpcRegistry.LOTHLORIEN_SENTINEL.identifier(), RaceRegistry.ELF, FACTION, TexturePresetsRegistry.LOTHLORIEN_ELF, List.of(
                WeightedGearData.create()
                        .add(EquipmentSlot.HEAD, GearSlotPool.create()
        ...
        RANGER = new NpcType(NpcRegistry.LOTHLORIEN_RANGER.identifier(), RaceRegistry.ELF, FACTION, TexturePresetsRegistry.LOTHLORIEN_ELF, List.of(
                WeightedGearData.create()
                        .add(EquipmentSlot.HEAD, GearSlotPool.create()
        ...
        WARRIOR = new NpcType(NpcRegistry.LOTHLORIEN_WARRIOR.identifier(), RaceRegistry.ELF, FACTION, TexturePresetsRegistry.LOTHLORIEN_ELF, List.of(
                WeightedGearData.create()
                        .add(EquipmentSlot.HEAD, GearSlotPool.create()
                                .add(WeightedItemData.create(EquipmentItemsME.LORIEN_LEATHER_HELMET))
                                .add(WeightedItemData.create(EquipmentItemsME.LORIEN_DIADEM))
        ...
        KNIGHT = new NpcType(NpcRegistry.LOTHLORIEN_KNIGHT.identifier(), RaceRegistry.ELF, FACTION, TexturePresetsRegistry.LOTHLORIEN_ELF, List.of(
                WeightedGearData.create()
                        .add(EquipmentSlot.HEAD, GearSlotPool.create()
        ...
        GUARD = new NpcType(NpcRegistry.LOTHLORIEN_GUARD.identifier(), RaceRegistry.ELF, FACTION, TexturePresetsRegistry.LOTHLORIEN_ELF, List.of(
                WeightedGearData.create()
                        .add(EquipmentSlot.HEAD, GearSlotPool.create()
        ...
        EGLADIL_SENTINEL = new NpcType(NpcRegistry.LOTHLORIEN_EGLADIL_SENTINEL.identifier(), RaceRegistry.ELF, FACTION, TexturePresetsRegistry.LOTHLORIEN_ELF, List.of(
                WeightedGearData.create()
                        .add(EquipmentSlot.HEAD, GearSlotPool.create()
        ...
        EGLADIL_COMMANDER = new NpcType(NpcRegistry.LOTHLORIEN_EGLADIL_COMMANDER.identifier(), RaceRegistry.ELF, FACTION, TexturePresetsRegistry.LOTHLORIEN_LORD, List.of(
                WeightedGearData.create()
                        .add(EquipmentSlot.HEAD, GearSlotPool.create()
        ...
        LORD = new NpcType(NpcRegistry.LOTHLORIEN_LORD.identifier(), RaceRegistry.ELF, FACTION, TexturePresetsRegistry.LOTHLORIEN_LORD, List.of(
                WeightedGearData.create()
                        .add(EquipmentSlot.HEAD, GearSlotPool.create()

...
public class GondorianNpcTypePool {
    ...
    static {
        PEASANT = new NpcType(NpcRegistry.GONDOR_PEASANT.identifier(), RaceRegistry.HUMAN, FACTION, TexturePresetsRegistry.GONDOR_PEASANT, List.of(
        ...
        MILITIA = new NpcType(NpcRegistry.GONDOR_MILITIA.identifier(), RaceRegistry.HUMAN, FACTION, TexturePresetsRegistry.GONDOR_PEASANT, List.of(
                WeightedGearData.create()
                        .add(EquipmentSlot.HEAD, GearSlotPool.create()
                                .add(WeightedItemData.create(EquipmentItemsME.LEATHER_SKULLCAP))
        ...
        SOLDIER = new NpcType(NpcRegistry.GONDOR_SOLDIER.identifier(), RaceRegistry.HUMAN, FACTION, TexturePresetsRegistry.GONDOR_SOLDIER, List.of(
                WeightedGearData.create()
                        .add(EquipmentSlot.HEAD, GearSlotPool.create()
        ...
        KNIGHT = new NpcType(NpcRegistry.GONDOR_KNIGHT.identifier(), RaceRegistry.HUMAN, FACTION,  TexturePresetsRegistry.GONDOR_SOLDIER, List.of(
                WeightedGearData.create()
        ...
        VETERAN = new NpcType(NpcRegistry.GONDOR_VETERAN.identifier(), RaceRegistry.HUMAN, FACTION,  TexturePresetsRegistry.GONDOR_SOLDIER, List.of(
                WeightedGearData.create()
                        .add(EquipmentSlot.HEAD, GearSlotPool.create()
        ...
        CITADEL_GUARD = new NpcType(NpcRegistry.GONDOR_CITADEL_GUARD.identifier(), RaceRegistry.HUMAN, FACTION, TexturePresetsRegistry.GONDOR_SOLDIER, List.of(
                WeightedGearData.create()
        ...
        FOUNTAIN_GUARD = new NpcType(NpcRegistry.GONDOR_FOUNTAIN_GUARD.identifier(), RaceRegistry.HUMAN, FACTION, TexturePresetsRegistry.GONDOR_SOLDIER, List.of(
                WeightedGearData.create()
        ...
        KING_GUARD = new NpcType(NpcRegistry.GONDOR_KING_GUARD.identifier(), RaceRegistry.HUMAN, FACTION, TexturePresetsRegistry.GONDOR_SOLDIER, List.of(
                WeightedGearData.create()
        ...
        LEADER = new NpcType(NpcRegistry.GONDOR_LEADER.identifier(), RaceRegistry.HUMAN, FACTION,  TexturePresetsRegistry.GONDOR_LORD, List.of(
                WeightedGearData.create()

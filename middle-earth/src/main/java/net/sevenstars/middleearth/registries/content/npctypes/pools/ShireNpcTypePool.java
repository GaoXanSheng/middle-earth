...
public class ShireNpcTypePool {
    ...
    static {
        PEASANT = new NpcType(NpcRegistry.SHIRE_PEASANT.identifier(), RaceRegistry.HOBBIT, FACTION, TexturePresetsRegistry.SHIRE_PEASANT, List.of(
        ...
        MILITIA = new NpcType(NpcRegistry.SHIRE_MILITIA.identifier(), RaceRegistry.HOBBIT, FACTION, TexturePresetsRegistry.SHIRE_MILITIA, List.of(
                WeightedGearData.create()
                        .add(EquipmentSlot.HEAD, GearSlotPool.create()
                                .add(WeightedItemData.create(EquipmentItemsME.STRAW_HAT).withWeight(2))
                                .add(WeightedItemData.create(EquipmentItemsME.WOVEN_HAT).withWeight(2))
        ...
        SHIRRIFF = new NpcType(NpcRegistry.SHIRE_SHIRRIFF.identifier(), RaceRegistry.HOBBIT, FACTION, TexturePresetsRegistry.SHIRE_SHIRRIFF, List.of(
                WeightedGearData.create()

...
public class FactionRegistry {
    ...
    public final static ResourceKey<Faction> LONGBEARDS_EREBOR = DynamicRegistriesME.of(FACTION_KEY, MiddleEarth.of(LONGBEARDS.identifier().getPath(), "erebor"));
    ...
    public final static ResourceKey<Faction> HOBGOBLIN_TRIBES_GUNDABAD =  DynamicRegistriesME.of(FACTION_KEY, MiddleEarth.of(HOBGOBLIN_TRIBES.identifier().getPath(), "gundabad"));
    ...
    private static void register(BootstrapContext<Faction> context, HolderGetter<Faction> registryEntryLookup, ResourceKey<Faction> registryKey, Faction element){
        ...
        // [LANG datagen]
        TranslationEntries.factionEntries.add(registryKey.identifier().getPath());

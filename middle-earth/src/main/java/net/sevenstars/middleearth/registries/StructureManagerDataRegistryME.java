...
public class StructureManagerDataRegistryME {
    ...
    private static StructureManagerData register(BootstrapContext<StructureManagerData> context, HolderGetter<StructureManagerData> registryEntryLookup, StructureManagerData structureManagerData) {
        ...
        String name = registryKey.identifier().getPath();
        ResourceKey<StructureManagerData> structureDataKey = ResourceKey.create(DynamicRegistriesME.STRUCTURE_MANAGER_DATA, Identifier.fromNamespaceAndPath(MiddleEarth.MOD_ID,name));
    ...
    static {
        GONDOR_GENERIC_NESTS = new StructureManagerData(Identifier.fromNamespaceAndPath(MiddleEarth.MOD_ID, "gondor_generic_nests"), List.of(
        ...
        EREBOR_GENERIC_NESTS = new StructureManagerData(Identifier.fromNamespaceAndPath(MiddleEarth.MOD_ID, "erebor_generic_nests"), List.of(
            ...
            new SpawnNestNodeData(MiddleEarth.fetchId("erebor_generic_nests.stable_nest"), 1500, List.of(
                    ...
                    new StructureSpawnNestPool(EntityTypes.PIG, 3).SetFixAmount(1),
                    new StructureSpawnNestPool(EntityTypes.DONKEY, 2).SetFixAmount(1)
            ))
        ));

        DALE_KEEP_NESTS = new StructureManagerData(Identifier.fromNamespaceAndPath(MiddleEarth.MOD_ID, "dale_keep_nests"), List.of(

...
public class RohirricNpcTypePool {
    ...
    static {
        PEASANT = new NpcType(NpcRegistry.ROHAN_PEASANT.identifier(), RaceRegistry.HUMAN, FACTION, TexturePresetsRegistry.ROHAN_PEASANT, List.of(
        ...
        MILITIA = new NpcType(NpcRegistry.ROHAN_MILITIA.identifier(), RaceRegistry.HUMAN, FACTION, TexturePresetsRegistry.ROHAN_PEASANT, List.of(
                WeightedGearData.create()
                        .add(EquipmentSlot.HEAD, GearSlotPool.create()
        ...
        SOLDIER = new NpcType(NpcRegistry.ROHAN_SOLDIER.identifier(), RaceRegistry.HUMAN, FACTION, TexturePresetsRegistry.ROHAN_SOLDIER, List.of(
                WeightedGearData.create()
                        .add(EquipmentSlot.HEAD, GearSlotPool.create()
        ...
        KNIGHT = new NpcType(NpcRegistry.ROHAN_KNIGHT.identifier(), RaceRegistry.HUMAN, FACTION, TexturePresetsRegistry.ROHAN_SOLDIER, List.of(
                WeightedGearData.create()
                        .add(EquipmentSlot.HEAD, GearSlotPool.create()
        ...
        ROYAL_GUARD = new NpcType(NpcRegistry.ROHAN_ROYAL_GUARD.identifier(), RaceRegistry.HUMAN, FACTION, TexturePresetsRegistry.ROHAN_SOLDIER, List.of(
                WeightedGearData.create()
        ...
        EORLING_MARSHAL = new NpcType(NpcRegistry.ROHAN_EORLING_MARSHAL.identifier(), RaceRegistry.HUMAN, FACTION, TexturePresetsRegistry.ROHAN_LORD, List.of(
                WeightedGearData.create()
        ...
        HORSE_LORD = new NpcType(NpcRegistry.ROHAN_HORSE_LORD.identifier(), RaceRegistry.HUMAN, FACTION, TexturePresetsRegistry.ROHAN_LORD, List.of(
                WeightedGearData.create()

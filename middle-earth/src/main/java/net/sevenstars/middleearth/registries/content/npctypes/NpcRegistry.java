...
public class NpcRegistry {
    ...
    private static void register(BootstrapContext<NpcType> context, HolderGetter<NpcType> registryEntryLookup, ResourceKey<NpcType> registryKey, NpcType element){
        ...
        // [LANG datagen]
        TranslationEntries.npcTypeEntries.add(registryKey.identifier().getPath());
        TranslationEntries.spawnEggEntries.add(element.getId());
    }

    private static Identifier createID(ResourceKey<Faction> faction, String name){
        return MiddleEarth.of(faction.identifier().getPath(), name);
    }

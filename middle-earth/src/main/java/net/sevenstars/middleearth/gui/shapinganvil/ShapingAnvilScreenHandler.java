...
public class ShapingAnvilScreenHandler extends AbstractContainerMenu {
        ...
        this.addSlot(new ShapingAnvilSlot(inventory, 0, 136, 33){
            ...
            public void setChanged() {
                ...
                if(player.level().isClientSide()) {
                    ShapingAnvilScreen screen = (ShapingAnvilScreen)Minecraft.getInstance().gui.screen();
    ...
    public void updateStack(Container inventory) {
        ...
        if (!this.world.isClientSide()){
            ...
            this.availableRecipes = serverRecipeManager.getAllMatches(RecipesME.ANVIL_SHAPING, new SingleRecipeInput(input), this.world).toList();

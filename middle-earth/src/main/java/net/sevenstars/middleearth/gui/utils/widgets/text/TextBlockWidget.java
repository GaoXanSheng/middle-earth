...
public class TextBlockWidget extends ModWidget {
    ...
    public void draw(GuiGraphicsExtractor context, boolean showLimit, boolean showBorders){
        if(showBorders) {
            context.verticalLine(startX, startY, startY + height, CommonColors.RED);
            context.verticalLine(startX + width, startY, startY + height, CommonColors.RED);
            context.horizontalLine(startX, startX + width, startY, CommonColors.RED);
            context.horizontalLine(startX, startX + width, startY + height, CommonColors.RED);
        }
        draw(context, showLimit);
    }

    public void draw(GuiGraphicsExtractor context, boolean showTextLimit){
        int currentHeight = 0;
    ...
    private void drawTextLimitLine(GuiGraphicsExtractor context, int currentStart) {
    ...
    private void drawTextLine(GuiGraphicsExtractor context, List<Word> currentLine, int currentStart, boolean isEnd) {
        if (isJustified && !isEnd) {
            ...
            context.text(textRenderer, lastWordText,

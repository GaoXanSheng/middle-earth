...
public class PlayerBookScreen extends Screen {
    private static final Identifier TEXTURE = Identifier.fromNamespaceAndPath(MiddleEarth.MOD_ID, "textures/gui/player_book.png");
    ...
    public void extractRenderState(GuiGraphicsExtractor context, int mouseX, int mouseY, float deltaTicks) {
        ...
        if(currentPage == 0) {
            ...
            context.textWithWordWrap(font, Component.translatable("screen." + MiddleEarth.MOD_ID + ".playerbook.description"), startX + 38, startY + (int)(HEIGHT * 0.22f), 116, CommonColors.BLACK, false);
            ...
            for(Chapter chapter : chapters) {
                ...
                if (mouseX >= startTooltipX && mouseX <= startTooltipX + (chapter.name.length() * 4.75) + 5 && mouseY >= startTooltipY && mouseY <= startTooltipY + 9) {
                    context.setTooltipForNextFrame(this.minecraft.font, Lists.transform(
                ...
                context.item(chapter.icon.getDefaultInstance(), startX + (int)(WIDTH * 0.5f) + 12, startY + (int)(HEIGHT * 0.22f) - 4 + (index * 18));
                context.text(font, text, startX + (int)(WIDTH * 0.5f) + 32, startY + (int)(HEIGHT * 0.22f) + (index * 18), CommonColors.BLACK, false);
                index++;
            }
        } else {
            ...
            if(pageData != null) {
                ...
                if(pageData.image != null) {
                    context.blit(RenderPipelines.GUI_TEXTURED, pageData.image,
                            startX, startY, 0, 0,
                            WIDTH, HEIGHT, 320, 320);
                }

                context.textWithWordWrap(font, Component.translatable("screen." + MiddleEarth.MOD_ID + "." + pageData.leftPageDescription),
                        startX + 38, startY + (int)(HEIGHT * 0.2f), 116, CommonColors.BLACK, false);
                context.textWithWordWrap(font, Component.translatable("screen." + MiddleEarth.MOD_ID + "." + pageData.rightPageDescription),
                        startX + (int)(WIDTH * 0.5f) + 16, startY + (int)(HEIGHT * 0.16f), 114, CommonColors.BLACK, false);
            }
        }
    ...
    public static void drawScaledText(Font textRenderer, GuiGraphicsExtractor context, Component text, int x, int y, float scale, int color, boolean centered) {
        Matrix3x2fStack matrices = context.pose();
        matrices.pushMatrix();
        matrices.scale(scale);

        if (centered) {
            context.text(textRenderer, text, (int)(x / scale) - (int)((textRenderer.width(text) * Math.pow(scale, 0.5f)) / 2),
    ...
    static {
        ...
        chaptersPages.put(PlayerBookChapters.GETTING_STARTED, List.of(
                new PlayerBookPageData().withTitle("playerbook.chapter_getting_started").withImage(Identifier.fromNamespaceAndPath(MiddleEarth.MOD_ID, PATH + "getting_started1.png"))
        ...
        chaptersPages.put(PlayerBookChapters.MINING, List.of(
                new PlayerBookPageData().withTitle("playerbook.chapter_mining").withImage(Identifier.fromNamespaceAndPath(MiddleEarth.MOD_ID, PATH + "mining1.png"))
                ...
                new PlayerBookPageData().withTitle("playerbook.cave_monsters").withImage(Identifier.fromNamespaceAndPath(MiddleEarth.MOD_ID, PATH + "mining3.png"))
        ...
        chaptersPages.put(PlayerBookChapters.SMITHING, List.of(
                new PlayerBookPageData().withTitle("playerbook.chapter_smithing").withImage(Identifier.fromNamespaceAndPath(MiddleEarth.MOD_ID, PATH + "smithing1.png"))
                        .withLeftPageDesc("playerbook.smithing_desc")
                        .withRightPageDesc("playerbook.smithing_desc_right"),
                new PlayerBookPageData().withTitle("playerbook.copper_alloys").withImage(Identifier.fromNamespaceAndPath(MiddleEarth.MOD_ID, PATH + "smithing2.png"))
                ...
                new PlayerBookPageData().withTitle("playerbook.casting").withImage(Identifier.fromNamespaceAndPath(MiddleEarth.MOD_ID, PATH + "smithing3.png"))
                        .withLeftPageDesc("playerbook.smithing_casting_desc")
                        .withRightPageDesc("playerbook.smithing_casting_desc_right"),
                new PlayerBookPageData().withTitle("playerbook.shaping_anvil").withImage(Identifier.fromNamespaceAndPath(MiddleEarth.MOD_ID, PATH + "smithing4.png"))
                ...
                new PlayerBookPageData().withTitle("playerbook.quenching").withImage(Identifier.fromNamespaceAndPath(MiddleEarth.MOD_ID, PATH + "smithing5.png"))
                        .withLeftPageDesc("playerbook.smithing_quenching_desc")
                        .withRightPageDesc("playerbook.smithing_quenching_desc_right"),
                new PlayerBookPageData().withTitle("playerbook.artisan_table").withImage(Identifier.fromNamespaceAndPath(MiddleEarth.MOD_ID, PATH + "smithing6.png"))
                        .withLeftPageDesc("playerbook.smithing_artisan_table_desc")
                        .withRightPageDesc("playerbook.smithing_artisan_table_desc_right"),
                new PlayerBookPageData().withTitle("playerbook.artisan_table").withImage(Identifier.fromNamespaceAndPath(MiddleEarth.MOD_ID, PATH + "smithing7.png"))
        ...
        chaptersPages.put(PlayerBookChapters.ENCHANTING, List.of(
                new PlayerBookPageData().withTitle("playerbook.chapter_enchanting").withImage(Identifier.fromNamespaceAndPath(MiddleEarth.MOD_ID, PATH + "enchanting1.png"))
                        .withLeftPageDesc("playerbook.enchanting_desc")
                        .withRightPageDesc("playerbook.enchanting_desc_right"),
                new PlayerBookPageData().withTitle("playerbook.inscription_table").withImage(Identifier.fromNamespaceAndPath(MiddleEarth.MOD_ID, PATH + "enchanting2.png"))
        ...
        chaptersPages.put(PlayerBookChapters.MOUNTS, List.of(
                ...
                new PlayerBookPageData().withTitle("playerbook.broadhoof_goat").withImage(Identifier.fromNamespaceAndPath(MiddleEarth.MOD_ID, PATH + "mount_broadhoof_goat.png"))
                        .withLeftPageDesc("playerbook.mount_broadhoof_goat_desc")
                        .withRightPageDesc("playerbook.mount_broadhoof_goat_desc_right"),
                new PlayerBookPageData().withTitle("playerbook.great_horn").withImage(Identifier.fromNamespaceAndPath(MiddleEarth.MOD_ID, PATH + "mount_great_horn.png"))
                        .withLeftPageDesc("playerbook.mount_great_horn_desc")
                        .withRightPageDesc("playerbook.mount_great_horn_desc_right"),
                new PlayerBookPageData().withTitle("playerbook.warg").withImage(Identifier.fromNamespaceAndPath(MiddleEarth.MOD_ID, PATH + "mount_warg.png"))
                        .withLeftPageDesc("playerbook.mount_warg_desc")
                        .withRightPageDesc("playerbook.mount_warg_desc_right"),
                new PlayerBookPageData().withTitle("playerbook.cave_troll").withImage(Identifier.fromNamespaceAndPath(MiddleEarth.MOD_ID, PATH + "mount_cave_troll.png"))
        ...
        chaptersPages.put(PlayerBookChapters.DUNGEONS, List.of(
                ...
                new PlayerBookPageData().withTitle("playerbook.brigands").withImage(Identifier.fromNamespaceAndPath(MiddleEarth.MOD_ID, PATH + "dungeon_brigands.png"))
                        .withLeftPageDesc("playerbook.dungeon_brigands_desc")
                        .withRightPageDesc("playerbook.dungeon_brigands_desc_right"),
                new PlayerBookPageData().withTitle("playerbook.spider_burrows").withImage(Identifier.fromNamespaceAndPath(MiddleEarth.MOD_ID, PATH + "dungeon_spider_burrows.png"))

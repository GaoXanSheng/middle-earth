...
public class SearchBarWidget extends ModWidget {
    private static final Identifier SEARCH_WIDGET = Identifier.fromNamespaceAndPath(MiddleEarth.MOD_ID, "textures/gui/widget/search_widget.png");
    ...
    public int drawSearchBarCentered(GuiGraphicsExtractor context, int centerX, int startY, Font textRenderer) {
        int startX = centerX - (desiredWidth / 2);
        return drawSearchBar(context, startX, startY, textRenderer);
    }

    public int drawSearchBarAnchored(GuiGraphicsExtractor context, int anchorX, int startY, boolean isLeftAnchor, Font textRenderer) {
        int startX = anchorX;
        if (!isLeftAnchor)
            startX -= desiredWidth;
        return drawSearchBar(context, startX, startY, textRenderer);
    ...
    public int drawSearchBar(GuiGraphicsExtractor context, int startX, int startY, Font textRenderer) {
        int panelSizeX = 102;
        int panelSizeY = 18;
        ...
        // Search bar button
        context.blit(RenderPipelines.GUI_TEXTURED, SEARCH_WIDGET,
        ...
        context.text(textRenderer, text,
    ...
    public int drawSearchResultsCentered(GuiGraphicsExtractor context, int centerX, int startY) {
        int startX = centerX - (desiredWidth / 2);
        return drawSearchResults(context, startX, startY);
    }

    public int drawSearchResultsAnchored(GuiGraphicsExtractor context, int anchorX, int startY, boolean isLeftAnchor) {
        int startX = anchorX;
        if (!isLeftAnchor)
            startX -= desiredWidth;
        return drawSearchResults(context, startX, startY);
    ...
    public int drawSearchResults(GuiGraphicsExtractor context, int startX, int startY) {
        ...
        if (searchResultToggle) {
            ...
            for (int i = 0; i < currentAmount; i++) {
                ...
                context.text(client.font, searchBarResult.getText(),
    ...
    private int drawSearchBarBackground(GuiGraphicsExtractor context, Identifier searchWidget, int startX, int startY) {
        int uvY = (getFocusEnabled() && searchBarToggleButton.isFocused()) ? 19 : 0;

        context.blit(RenderPipelines.GUI_TEXTURED, searchWidget,
    ...
    private int drawTop(GuiGraphicsExtractor context, Identifier searchWidget, int startX, int startY) {
        context.blit(RenderPipelines.GUI_TEXTURED, searchWidget,
    ...
    private int drawFooter(GuiGraphicsExtractor context, Identifier searchWidget, int startX, int startY) {
        context.blit(RenderPipelines.GUI_TEXTURED, searchWidget,
    ...
    private int drawBottom(GuiGraphicsExtractor context, Identifier searchWidget, int startX, int startY) {
        context.blit(RenderPipelines.GUI_TEXTURED, searchWidget,
    ...
    private int drawCenter(GuiGraphicsExtractor context, Identifier searchWidget, int startX, int startY, int currentAmount) {
        context.blit(RenderPipelines.GUI_TEXTURED, searchWidget,
    ...
    private int drawResultButtonBackground(GuiGraphicsExtractor context, Identifier searchWidget, int startX, int startY, int uvX, int uvY, int size) {
        context.blit(RenderPipelines.GUI_TEXTURED, searchWidget,

...
public class PheasantEntity extends Animal {
    ...
    protected Brain<?> makeBrain(Brain.Packed packed) {
        return PheasantBrain.create(this, packed);
    }
    ...
    public AgeableMob getBreedOffspring(ServerLevel world, AgeableMob entity) {
        return EntitiesWT.PHEASANT.create(world, EntitySpawnReason.BREEDING);
    }
    ...
    protected void playStepSound(BlockPos pos, BlockState state) {
        this.playSound(SoundEvents.CHICKEN_STEP.value(), 1.0f, 0.9f);
    }

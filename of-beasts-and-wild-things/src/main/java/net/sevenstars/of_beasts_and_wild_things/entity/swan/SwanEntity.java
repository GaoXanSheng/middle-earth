...
public class SwanEntity extends Animal {
    ...
    protected Brain<?> makeBrain(Brain.Packed packed) {
        return SwanBrain.create(this, packed);
    }
    ...
    public boolean isFood(ItemStack stack) {
        return stack.is(TagKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(OfBeastsAndWildThings.MOD_ID, "swan_food")));
    }
    ...
    public AgeableMob getBreedOffspring(ServerLevel world, AgeableMob entity) {
        SwanEntity child = EntitiesWT.SWAN.create(world, EntitySpawnReason.BREEDING);
    ...
    public static boolean isValidSwanFood(LivingEntity entity) {
        return BuiltInRegistries.ENTITY_TYPE.wrapAsHolder(entity.getType()).is(TagKey.create(Registries.ENTITY_TYPE, Identifier.fromNamespaceAndPath(OfBeastsAndWildThings.MOD_ID, "swan_food")));
    }

...
public class DeerEntity extends Animal {
    ...
    protected Brain<?> makeBrain(Brain.Packed packed) {
        return DeerBrain.create(this, packed);
    }
    ...
    public boolean isInvulnerableTo(ServerLevel world, DamageSource source) {
        return super.isInvulnerableTo(world, source) || source.is(DamageTypes.SWEET_BERRY_BUSH);
    }
    ...
    public AgeableMob getBreedOffspring(ServerLevel world, AgeableMob entity) {
        return EntitiesWT.DEER.create(world, EntitySpawnReason.BREEDING);
    }
